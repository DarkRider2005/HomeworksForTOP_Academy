...
namespace Dictionary_FinallyProject
{
    ...
    public class Dictionary
    {
        ...
        private static TypeDictionary _typeDic;
        ...
        /// <summary>
        /// Индекс пути к файлу, который хранит переводы слов
        /// </summary>
        private int _indexPathForTranslate = 0;
        /// <summary>
        /// Индекс пути к файлу, который хранит переводы слов на третьем языке
        /// </summary>
        ...
        public Dictionary(TypeDictionary type)
        {
            ...
            if (_typeDic == TypeDictionary.RussianInEnglish || _typeDic == TypeDictionary.RussianInGerman)
            {
                _fromLanguage = "Rus";
                _indexPathForWord = 0;
            }

            else if (_typeDic == TypeDictionary.EnglishInGerman || _typeDic == TypeDictionary.EnglishInRussian)
            {
                _fromLanguage = "Eng";
                _indexPathForWord = 1;
            }

            else if (_typeDic == TypeDictionary.GermanInRussian || _typeDic == TypeDictionary.GermanInEnglish)
            {
                _fromLanguage = "Ger";
                _indexPathForWord = 2;
            }
            ...
            {
                if (_typeDic == TypeDictionary.RussianInEnglish)
                {
                    _toLanguage = "Eng";
                    _thirdLanguage = "Ger";
                ...
                else if (_typeDic == TypeDictionary.RussianInGerman)
                {
                    _toLanguage = "Ger";
                    _thirdLanguage = "Eng";
            ...
            {
                if (_typeDic == TypeDictionary.EnglishInGerman)
                {
                    _toLanguage = "Ger";
                    _thirdLanguage = "Rus";
                    _indexPathForTranslate = 2;
                ...
                else if (_typeDic == TypeDictionary.EnglishInRussian)
                {
                    _toLanguage = "Rus";
                    _thirdLanguage = "Ger";
            ...
            {
                if (_typeDic == TypeDictionary.GermanInEnglish)
                {
                    _toLanguage = "Eng";
                    _thirdLanguage = "Rus";
                    _indexPathForTranslate = 1;
        ...
        public void FindTranslateWord(string word)
        {
            try
            {
                ...
                else
                {
                    ...
                    {
                        string trans = " ";
                        Console.Write($"Введите перевод слова {word} на {_toLanguage} -> ");
